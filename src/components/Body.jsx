        ...
        case 1:
            return( 
                   ...
                   <div className="timeline-content">
                    ...
                    <Time date="Sep-Oct 2022" text="Learned basic Java for Robotics; Variables, Loops, Objects, Classes, Inheritance" />
                    <Time date="Jul 2023" text="Coded more simple math-based HTML projects" />
                    <Time date="10/7/2023" text="Started Robotics FTC github repo; implemented my first online public-source Java library called FtcRobotController" />
                    <Time date="Nov 2023" text="Learned to implement Java library called VisionPortal for Robotics camera detection" />
                    <Time date="Jan 2023" text="Learned intermediate Java and deeper object-oriented programming concepts; ArrayList, HashMaps, HashSets, BigInteger" />
                    <Time date="Feb 2023" text="Learned basic algorithms and data structures; Linked Lists, Binary Search Trees; Started on LeetCode" />
                    <Time date="Mar-Apr 2023" text="Learned to implement Java library called RoadRunner for Robotics trajectory building for Autonomous movement" />
                    ...
                    <Time date="6/28/2024" text="Learned to implement a dynamic scene changer in unity" />
                    <Time date="6/29/2024" text="Learned Unity animations, transitions, and tilesets" />
                    <Time date="6/30/2024" text="Learned PlayerPrefs; stored y-value of player upon scene change" />
                    <Time date="7/3/2024" text="Coded three levels; added generic tilemaps (i.e. 1x2 floor tile)" />
                    <Time date="7/4/2024" text="Learned bucket sort; started on NeetCode roadmap" />
                    <h2>Checkers Game</h2>
                    <Time date="7/6/2024" text="Started on checkers game in React; learned to pass data from children to parent by passing down a useState function as props of the child" />
                    <Time date="7/7/2024" text="Coded basic movement and rules for checkers pieces (non-king pieces)" />
                    <Time date="7/8/2024" text="Added king pieces in checkers; improved code readability; added basic win/draw conditions; made source elements become invisible when being dragged" />
                    <Time date="7/9/2024" text="Added win condition for making opposing side have no possible moves and three-fold repetition draw" />
                    <br/>
                    <Time date="7/10/2024" text="Started learning on roadmap.sh" />
                    <Time date="7/12/2024" text="Learned javascript fetch() api" />
                    <Time date="7/13/2024" text="Created a Pokemon Stats lookup with javascript fetch()" />
                    <Time date="7/14/2024" text="Learned FileReader and Image Web APIs"></Time>
                    <Time date="7/15/2024-7/20/2024" text="Learned to use React useEffect, useRef, and useContext hooks effectively and avoid common antipatterns"></Time>
                    </div>
                </div>
